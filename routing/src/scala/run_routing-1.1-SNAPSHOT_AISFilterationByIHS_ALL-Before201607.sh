...
AIS_TYPE="Before201607"
AIS_BASE_DIR="/ais/raw/2016/before201607/"
...
for YY in 01 02 03 04 05 06; do
    ...
    for FILTER_VALUE in "Bulk Carriers" "Dry Cargo/Passenger" "Fishing" "Miscellaneous" "Non-Merchant Ships" "Non-Propelled" "Non-Seagoing Merchant Ships" "Non-Ship Structures" "Offshore" "Tankers"; do
        ...
        spark2-submit \
            ...
            "$FILTER_TYPE" \
            "$FILTER_VALUE" \
            "$OUT_DIR" &>  "run_routing-1.1-SNAPSHOT_AISFilterationByIHS_ALL-Before201607_${FILTER_VALUE_OUT_NAME}.log"
...
for YY in 01 02 03 04 05 06; do
    for FILTER_VALUE in 300 2000; do
        ...
        spark2-submit \
            ...
            "$FILTER_TYPE" \
            "$FILTER_VALUE" \
            "$OUT_DIR" &> "run_routing-1.1-SNAPSHOT_AISFilterationByIHS_ALL-Before201607_GrossTonnage-gt${FILTER_VALUE}.log"
